...
from app.api.routes.feishu_admin_read_tool_request_models import FeishuCalendarEventsRequest
...
@router.post("/apps/{app_config_id}/calendar/events", dependencies=[Depends(require_admin_api_token)])
async def list_calendar_events(
    app_config_id: UUID,
    data: FeishuCalendarEventsRequest,
