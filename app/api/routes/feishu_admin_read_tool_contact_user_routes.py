...
from app.api.routes.feishu_admin_read_tool_request_models import FeishuContactUsersRequest
...
@router.post("/apps/{app_config_id}/contacts/users", dependencies=[Depends(require_admin_api_token)])
async def list_contact_users(
    app_config_id: UUID,
    data: FeishuContactUsersRequest,
