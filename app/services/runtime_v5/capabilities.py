...
RUNTIME_CAPABILITIES: tuple[RuntimeCapability, ...] = (
    ...
    RuntimeCapability("attendance_query", "attendance", "query_records", "query", "self", "bot", label="查询飞书考勤", route_path="feishu_attendance_query"),
    ...
    RuntimeCapability("slides_read", "slides", "read_slides", "query", "company", "bot", label="读取飞书幻灯片", route_path="feishu_slides_read"),
    ...
    RuntimeCapability("whiteboard_read", "whiteboard", "read_whiteboard", "query", "company", "bot", label="读取飞书画板", route_path="feishu_whiteboard_read"),
...
SKILL_ATOMIC_CAPABILITIES: tuple[SkillAtomicCapability, ...] = (
    ...
    SkillAtomicCapability("attendance", "query_records", "lark-attendance", "query", "bot", "low", exposed=True, label="查询考勤记录"),
    ...
    SkillAtomicCapability("slides", "read_slides", "lark-slides", "query", "bot", "low", exposed=True, label="读取幻灯片"),
    ...
    SkillAtomicCapability("whiteboard", "read_whiteboard", "lark-whiteboard", "query", "bot", "low", exposed=True, label="读取画板"),
